...
export default class Footer extends React.Component {
  render(){
    return (
      <FooterSection>
        <Logo>
            <svg width="32" height="36" viewBox="0 0 55 63" fill="none" xmlns="http://www.w3.org/2000/svg" className="letter">
            <path d="M20.0745 34.6485L8.84014 46.1362V62.2561H0V0H8.84014V34.8338L42.359 0H52.4883L26.1521 27.9782L54.33 62.2561H44.0165L20.0745 34.6485Z" fill="#FFFFFF"/>
            </svg>
            <svg width="27" height="31" viewBox="0 0 47 54" fill="none" xmlns="http://www.w3.org/2000/svg" className="letter">
            <path d="M31.5323 35.842V48.4414L36.8732 45.2916V32.6921L31.5323 35.842Z" fill="#FFFFFF"/>
